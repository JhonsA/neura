...
// Scattered across the sky area above the wave crests.
const STARS: Array<[number, number, number, number]> = [
  [42,  38,  1.2, 0.72],  [125, 15,  0.9, 0.50],
  [202, 52,  1.4, 0.82],  [74,  105, 0.8, 0.44],
  [340, 28,  1.1, 0.64],  [278, 75,  0.9, 0.58],
  [88,  162, 0.8, 0.50],  [310, 135, 1.2, 0.68],
  [160, 122, 0.7, 0.38],  [240, 14,  1.0, 0.54],
  [368, 92,  0.8, 0.48],  [25,  190, 1.0, 0.56],
  [355, 188, 0.7, 0.42],  [218, 178, 1.2, 0.64],
  [148, 68,  0.8, 0.46],  [318, 55,  0.7, 0.42],
  [55,  225, 0.9, 0.38],  [175, 245, 0.8, 0.35],
  [292, 230, 0.9, 0.40],  [385, 150, 0.6, 0.38],
]
